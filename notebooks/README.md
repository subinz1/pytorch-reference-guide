...
| 43 | `43_production_serving.ipynb` | [Production Serving](../43_production_serving/) | Batched inference, dynamic batching, torch.compile, CUDA Graphs, monitoring |
| 44 | `44_performance_case_studies.ipynb` | [Performance Case Studies](../44_performance_case_studies/) | DataLoader, attention, compile, memory reduction, multi-GPU scaling |
